                ...
                <div key={purchase.id} className="grid grid-cols-1">
                  ...
                  <div className=" flex items-end justify-between border-b-2 border-gray-300 pb-3">
                    <h3 className=" flex items-center gap-5 text-black font-semibold text-base">
                      ...
                      <span className=" text-gray-600 font-normal">
                        Order Date: {moment(purchase.createdAt).format('DD MM YY')}
                      </span>
                    </h3>
                  </div>
                  {/* header ends  */}
                  ...
                  <div className=" grid grid-cols-1 md:grid-cols-3 gap-3 mt-3 border-b-2 border-gray-200 pb-3">
                    ...
                    <div>
                      ...
                      <p className=" text-black mb-1">Subtotal: ${purchase.totalCost}</p>
                  ...
                  <div className=" flex flex-col gap-2 mt-4">
                  {
                    purchase.productPurchases.map((el) => (
                      <div key={el.id} className=" flex gap-3 items-center justify-between border-b-2 border-gray-200 pb-3">
                      ...
                      <div className=" flex flex-col gap-0">
                        ...
                        <p className=" text-black mb-1">{el.product.productName}</p>
                        <h3 className=" font-medium text-gray-400">USD{el.product.cost}</h3>
                      </div>
                      <div className=" flex flex-col gap-0">
